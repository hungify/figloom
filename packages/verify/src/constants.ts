...
export const DEFAULT_MAX_GOLD_AGE_MS = DEFAULT_MAX_BASELINE_AGE_MS;
...
export const ROUND4_FACTOR = 10_000;
...
export const SPEC_SIZE_TOLERANCE_MIN_PX = 2;
export const SPEC_SIZE_TOLERANCE_PERCENT = 0.005;
