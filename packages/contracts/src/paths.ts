export const FIGLOOM_DIR = ".figloom";
...
export const VISUAL_VERIFICATIONS_ROOT = `${FIGLOOM_DIR}/${VISUAL_VERIFICATIONS_DIR}`;
export const DEFAULT_DISCOVERY_DIR = `${FIGLOOM_DIR}/${DISCOVERY_DIR_NAME}`;
export const DEFAULT_AUTH_STATE_PATH = `${FIGLOOM_DIR}/${AUTH_STATE_RELATIVE_PATH}`;
