...
const contracts: DashboardContractResult[] = [
  {
    ...
    phase: 'complete',
    baselineKind: 'figma',
    baseline: { path: paths.checkout.baseline, provenance: 'figma://demo/120:44', ...CHECKOUT_SIZE },
    actual: { path: paths.checkout.actual, url: 'http://127.0.0.1:3000/checkout', ...CHECKOUT_SIZE },
  ...
  },
  {
    ...
    phase: 'complete',
    baselineKind: 'web',
    baseline: { path: paths.header.baseline, provenance: 'https://example.com/main', ...HEADER_SIZE },
